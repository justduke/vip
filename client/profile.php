...
<div class="breadcomb-area">
		<div class="container">
			<div class="row">
                ...
                <a href="index.php?available"><button  data-placement="left" title="Home" class="btn"><i class="notika-icon notika-house"></i></button> </a>
								</div>
							</div>
						</div>
					</div>
                                ...
                                <div class="preview-img-pro-ad">
                                    <div class="maincrop-img">
                                        ...
                                        <div class="image-crp-img">
                                            <div class=" btn-group" style="display:flex;">
                                              <ul>     
                                                <li class="notika-icon notika-star"></li>
                                                <li class="notika-icon notika-star"></li>
                                                <li class="notika-icon notika-star"></li>
                                                <li class="notika-icon notika-star"></li>
                                                <li class="notika-icon notika-star"></li>
                                            ...
                                            <p>Username: Khgh256</p>
                                            <p>Email: kagehc@gmail.com</p>
                                            <p>Phone: +4875393 3578</p>
                                            <div class="btn-group images-cropper-pro">
                                                <label title="Upload image file" for="inputImage" class="btn btn-primary img-cropper-cp">
														<input type="file" accept="image/*" name="file" id="inputImage" class="hide"> Upload Profile
													</label>
                                    ...
                                    <div class="cp-img-anal">
                                        ...
                                        <div class="btn-group images-action-pro">
                                            <button class="btn btn-white" id="zoomIn" type="button">Reset Password</button>
                                            <button class="btn btn-white" id="zoomOut" type="button">Reset Username</button>
                                ...
                                <div class="accordion-stn mg-t-30">
                                    <div class="panel-group" data-collapse-color="nk-pink" id="accordionPink" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-collapse notika-accrodion-cus">
                                            ...
                                            <div id="accordionPink-one" class="collapse" role="tabpanel">
