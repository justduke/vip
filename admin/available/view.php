                ...
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                    <div class="inbox-left-sd">
                        ...
                        <div class="form-group">
                            <div class="nk-int-st search-input search-overt">
                                <input type="text" class="form-control" placeholder="Search Reassign" />
                            ...
                            <table class="table table-striped table-hover table-condensed table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Steve Duke</td>
                                        <td><span class="label label-warning"> Reassigned</span></td>
                                        <td>12:1:13</td>
                                    </tr>
                                    <tr>
                                        <td><a href="#">090438</a></td>
                                    ...
                                    <tr>
                                        <td><a href="#">090438</a></td>
                                        <td>Steve Duke</td>
                                        <td><span class="label label-warning"> Available</span></td>
                                        <td>12:1:13</td>
                                    </tr>
                                    <tr>
                                        <td><a href="#">090438</a></td>
                    ...
                    <div class="inbox-left-sd">
						<div class="compose-ml">
                            ...
                            <span class="btn" href="#">
                                Order <h4> #:9843990 </h4>
                                <button type="button" class="label btn-info" data-toggle="modal" data-target="#modalUpdate" type=""> Update Details </button>
                            </span>
                        </div>
