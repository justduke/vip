            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        ...
                        <div class="img-rounded"><a href="progress.php"><img src="../img/widgets/file.png" width="54px"alt=""></a></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        ...
                        <div class="img-rounded"><a href="#"><img src="../img/widgets/Iconshock.ico" width="54px"alt=""></a></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        ...
                        <div class="img-rounded"><a href="#"><img src="../img/widgets/file.png" width="54px"alt=""></a></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        ...
                        <div class="img-rounded"><a href="#"><img src="../img/widgets/bids.png" width="54px"alt=""></a></div>
                    </div>
                </div>
            </div>
        </div>
