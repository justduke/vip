			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="breadcomb-list">
                        ...
                        <br>
                    <h5 style="color:aquamarine;"><a href="index.php?available">Available</a>/ <a href="index.php?current">Current</a> </h5>
                    </div>
				</div>
			</div>
		</div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <a href="index.php?view_current">Tiger Nixon </a> </td>        
