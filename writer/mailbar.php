                        ...
                        <div class="inbox-status">
                            <ul class="inbox-st-nav inbox-ft">
                                <?php if(isset($_GET['mail'])){?>   
                                    <li><a class="active" href="index.php?mail"><i class="notika-icon notika-mail"></i> Inbox<span class="pull-right">12</span></a></li>
                                <?php } 
                                else{ ?>
                                 <li>
                                  <a class="active" href="index.php?mail"><i class="notika-icon notika-mail"></i>
