						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
								<div class="breadcomb-report">
									<button  data-placement="left" title="Download Report" class="btn"><a href="index.php?index"><i class="notika-icon notika-house"></i></a></i></button>
								</div>
							</div>
						</div>
					</div>
